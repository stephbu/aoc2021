namespace Aoc2021.Day3
{
    ...
    public class Puzzle1 
    {
        public static void Sample()
        {
            ...
            Dictionary<int, Dictionary<char, int>> bitMap = ComputeMap(lineChars);
            CalculatePower(bitMap);

        }

        private static Dictionary<int, Dictionary<char, int>> ComputeMap(IEnumerable<char[]> lineChars)
        {
        ...
        static void CalculatePower(Dictionary<int, Dictionary<char, int>> bitMap)
        {
