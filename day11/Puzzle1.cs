...
namespace Aoc2021.Day11
{
    ...
    public class Puzzle1 
    {
        ...
        public static void Sample2()
        {
            ...
            var result = DoWork(octopuses, 100);
        }
        ...
        internal static int DoWork(int[,,] octopuses, int maxSteps)
        {
            ...
            while (step < maxSteps)
            {
                ...
                totalFlashes += EnqueueFlashes(octopuses, flashQueue);
                ...
                step++;
                Console.WriteLine("Step/Flashes:{0}/{1}",step, totalFlashes);
                Dump(octopuses);
        ...
        private static void ResetFlashed(int[,,] octopuses)
        {
            var maxX = octopuses.GetLength(0);
            var maxY = octopuses.GetLength(1);
